...
echo 'alias dataharvest="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/DataHarvestco/DTHV" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/DataHarvestco/DTHV'"
...
rm -rf "$HOME/.config/@dataharvest"
rm -rf "$HOME/.config/@dataharvest"
rm -rf "$HOME/.config/dataharvest-core"
